...
#define DEF_RX_PIN  8                          // RX pin of Arduino. Must be connected to the TX pin of the SIM800 module.
#define DEF_TX_PIN  9                          // TX pin of Arduino. Must be connected to the RX pin of the SIM800 module.
...
#define DEF_BUFFER_SIZE  150                    // Size of the char[] ioBuffer which is used to buffer outgoing commands and incoming replies.
